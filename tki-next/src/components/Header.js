              ...
              <div className="row align-items-center">
                  <div className="col-lg-3">
                      <div className="site-logo">
                          <Link href="/">
                              <Image src="/images/logo.svg" alt="Logo" width={143} height={35} style={{ width: 'auto', height: 'auto' }} />
                          </Link>
                      </div>
                      {/* Logo End */}
                  </div>
                      ...
                      <div className="topbar-contact-info">
                          <ul>
                              <li>
                                  <a href="#">
                                      <div className="icon-box">
                                          <Image src="/images/icon-phone.svg" alt="" width={20} height={20} />
                                      </div>
                                      <p>+(123) 698-5245</p>
                                  </a>
                              </li>
                              <li>
                                  <a href="#">
                                      <div className="icon-box">
                                          <Image src="/images/icon-mail.svg" alt="" width={20} height={20} />
                                      </div>
                                       <p>info@domain.com</p>
                                  </a>
                              </li>
              ...
              <nav className="navbar navbar-expand-lg">
                  <div className="container">
                      ...
                      <Link className="navbar-brand" href="/">
                          <Image src="/images/footer-logo.svg" alt="Logo" width={143} height={35} style={{ width: 'auto', height: 'auto' }} />
                      </Link>
                      {/* Logo End */}
